document.addEventListener("DOMContentLoaded", function () {
  ...
  document
    ...
    .addEventListener("input", (e) => console.log("Search:", e.target.value));
  document
    .querySelector(".prev-btn")
    .addEventListener("click", () => alert("Previous page"));
  document
    .querySelector(".next-btn")
    .addEventListener("click", () => alert("Next page"));
