<?php require base_path('views/partials/auth/auth.php') ?>
    ...
    <main style="display: flex; justify-content: center; align-items: center; background-color: #f3f4f6;">
        <div style="margin-block: 2rem; background-color: #ffffff; padding: 2rem; border-radius: 8px; box-shadow: 0 4px 6px rgba(0, 0, 0, 0.1); width: fit-content">
            <form action="/companies/advertisements/store" method="post" enctype="multipart/form-data"
                ...
                <div style="display: flex; justify-content: end; grid-column: span 2; margin-top: 2rem">
