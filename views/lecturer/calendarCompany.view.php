...
<head>
    ...
    <link rel="stylesheet" href="/styles/pasindu/calendarCompany.css">
</head>
<body>
    <div class="profile-container">
        ...
        <div class="profile-card">
            ...
            <form id="profileForm">
                ...
                <input type="text" id="name" name="name" value="2024 / 11 / 29" required>

                <label for="id">Time</label>
                <input type="text" id="id" name="id" value="2 . 00 pm" required>
    ...
    <script src="/scripts/pasindu/calendarCompany.js"></script>
</body>
</html>
