    ...
    <div class="profile-container">
        ...
        <div class="profile-card">
            <div class="profile-header">
                ...
                <div>
                    <h2>Pasindu Madushan</h2>
                    <p>pmdwijegunasinghe@gmail.com</p>
                </div>
            </div>
            <form id="profileForm">
                <label for="name">Name</label>
                <input type="text" id="name" name="name" value="Pasindu Madushan" required>
                ...
                <label for="email">Email</label>
                <input type="email" id="email" name="email" value="pmdwijegunasinghe@gmail.com" required>
