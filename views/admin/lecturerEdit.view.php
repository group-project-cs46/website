...
<body>
    <form class="container" action="/lecturerEdition" method="post">
        <div class="header">
            <h2>Edit Lecturer</h2>
        </div>
        <!--add post -->
        <div class="form-container">
            <div class="left-column">
                ...
                <div class="form-group">
                    ...
                    <input required type="text" value="<?= $LECTURER['employee_id'] ?>" id="employee-no" name="employee-no" placeholder="Enter Lecturer ID No. Here">
                </div>
                ...
                <div class="form-group">
                    ...
                    <input value="<?= $LECTURER['email'] ?>" type="email" id="email" name="email" placeholder="Enter Email Address Here" required>
                </div>
